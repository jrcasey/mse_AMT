...
% add Tp mass to base cell quota, apply weighting coefficient 
q = q_native + 50*sum(TpMass); % g DW cell-1, 50 is a weight applied to encourage minimal number of transporters. This is an arbitrary weight.

% Params for paramsArmstrong
kcat = TpDat.kcat'; % mol Tp-1 s-1
